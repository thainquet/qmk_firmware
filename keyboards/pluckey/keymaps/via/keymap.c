...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_SCLN,                        KC_QUOT, KC_H,    KC_J,    KC_K,    KC_L,    KC_GRV, KC_ENT,
    ...
    [_LOWER] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_PGUP,      KC_PGDN, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_RAISE] = LAYOUT_all(
        ...
        _______, _______, _______, KC_VOLD, _______, _______, _______, KC_PGUP,      KC_PGDN, _______, _______, _______, KC_PGDN, _______, _______, _______,
